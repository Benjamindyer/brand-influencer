        ...
        <div className='min-h-screen bg-transparent p-4'>
            <div className='max-w-7xl mx-auto mt-8 space-y-6'>
                <div>
                    ...
                    <p className='text-[var(--color-text-secondary)]'>Platform overview and metrics</p>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                    ...
                    <Card>
                        <CardContent className='p-6'>
                            ...
                            <div className='text-sm text-[var(--color-text-secondary)]'>Total Briefs</div>
                            <div className='text-xs text-[var(--color-text-tertiary)] mt-2'>
                    ...
                    <Card>
                        <CardContent className='p-6'>
                            ...
                            <div className='text-sm text-[var(--color-text-secondary)]'>Active Subscriptions</div>
                            <div className='text-xs text-[var(--color-text-tertiary)] mt-2'>
